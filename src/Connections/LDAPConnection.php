...
use ErrorException;
use SanTran\LDAPAuth\Contracts\ConnectionInterface;
use SanTran\LDAPAuth\Contracts\DomainController;
use SanTran\LDAPAuth\Exceptions\ConnectionException;
...
class LDAPConnection implements ConnectionInterface
{
     ...
     *
     * @return \SanTran\LDAPAuth\Connections\DomainController
     */
